...
/* ===== Icons ===== */
const EditIcon = () => (
  <svg className="w-7 h-7 text-[#B31B1B]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function AdminEditComplaintPage() {
  ...
  const { complaint, isLoading: pageLoading, error: fetchError } = useComplaintDetail(complaintId, 'admin');
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-8">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-xl bg-[#B31B1B] hover:bg-red-800 text-white text-sm font-medium border-none cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={loading || success}
            >
              {loading ? (
                <>
